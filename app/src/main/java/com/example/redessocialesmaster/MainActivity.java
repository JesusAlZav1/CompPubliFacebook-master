    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        compartir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ShareLinkContent cont1 = new ShareLinkContent.Builder().setContentUrl(Uri.parse("https://atalayar.com/sites/default/files/styles/foto_/public/opinion/hacker-internet%20%281%29.jpg?itok=3nK8JgJX")).build();
